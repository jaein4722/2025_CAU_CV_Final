...
class submission_LCNet(nn.Module):
    def __init__(self, in_channels=3, num_classes=19, block_1=3, block_2=7, C = 32, P=0.5):
        super().__init__()
...
if __name__ == '__main__':
    ...
    model = submission_LCNet(num_classes=19).to(device)
